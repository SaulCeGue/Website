    ...
    <div class="container align-self-center">
      ...
      <form action ="validarUsu.php" method="post">
        <div class="form-group mb-3">
            ...
            <input name="email2" type="email" class="form-control" placeholder="&#128272; Ingresa tu correo">
        </div>
        <div class="form-group mb-3">
            <label class="font-weight-bold">Contraseña<span class="text-danger"></span></label>
            <input name="contra2" type="password" class="form-control" placeholder="&#128272; Ingresa una contraseña">
        </div>
